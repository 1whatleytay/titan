...
impl InstructionBuilder {
    ...
    pub fn with_normal_imm(mut self, value: i16) -> InstructionBuilder { // 12 bits
    ...
    pub fn with_branch_imm(mut self, value: i16) -> InstructionBuilder { // 12 bits
    ...
    pub fn with_store_imm(mut self, value: i16) -> InstructionBuilder { // 12 bits
        let value = value as i32 as u32;
    ...
    pub fn with_sham(mut self, value: u8) -> InstructionBuilder { // 5 bits
    ...
    // Always signed input.
    pub fn with_jal_imm(mut self, value: i32) -> InstructionBuilder { // 20 bits
    ...
    pub fn with_upper_imm(mut self, value: u32) -> InstructionBuilder { // 20 bits
        self.0 &= !(0b11111111111111111111 << 20); // clear 12-31
...
impl SplitImmediate {
    pub fn from_immediate(value: u32) -> SplitImmediate {
        ...
        assert_eq!((result.upper << 12).wrapping_add(result.lower as i32 as u32), value);
