...
impl Display for Instruction {
    fn fmt(&self, f: &mut Formatter<'_>) -> std::fmt::Result {
        match self {
            ...
            Instruction::Lb { s, t, imm } => write!(f, "lb {}, {}({})", s, sig(*imm), t),
            Instruction::Lbu { s, t, imm } => write!(f, "lbu {}, {}({})", s, sig(*imm), t),
            Instruction::Lh { s, t, imm } => write!(f, "lh {}, {}({})", s, sig(*imm), t),
            Instruction::Lhu { s, t, imm } => write!(f, "lhu {}, {}({})", s, sig(*imm), t),
            Instruction::Lw { s, t, imm } => write!(f, "lw {}, {}({})", s, sig(*imm), t),
            Instruction::Sb { s, t, imm } => write!(f, "sb {}, {}({})", s, sig(*imm), t),
            Instruction::Sh { s, t, imm } => write!(f, "sh {}, {}({})", s, sig(*imm), t),
            Instruction::Sw { s, t, imm } => write!(f, "sw {}, {}({})", s, sig(*imm), t),
